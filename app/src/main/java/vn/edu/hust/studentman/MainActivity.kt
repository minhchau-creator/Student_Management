...
//  }
//
//  // Hiển thị menu trên thanh 3 chấm
...
//        // Chuyển sang Activity thêm sinh viên
...
//    // Khởi tạo adapter
//    studentAdapter = StudentAdapter(students, { position, updatedStudent ->
//      showEditStudentDialog(position, updatedStudent)
//    }, { removedStudent ->
...
//  }
//
//  // Hiển thị Dialog thêm sinh viên mới
//  private fun showAddNewStudentDialog() {
//    val dialog = Dialog(this)
//    dialog.setContentView(R.layout.dialog_add_new_student)
//
...
//  }
//
//  // Hiển thị Dialog chỉnh sửa sinh viên
//  private fun showEditStudentDialog(position: Int, student: StudentModel) {
//    val dialog = Dialog(this)
//    dialog.setContentView(R.layout.dialog_add_new_student)
//
//    val editTextName: EditText = dialog.findViewById(R.id.editTextName)
...
//
//      if (name.isNotEmpty() && studentId.isNotEmpty()) {
//        students[position] = StudentModel(name, studentId)
